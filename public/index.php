...
$router->post('/cpanel/integrations/smtp', 'CpanelController@saveSmtpSettings', ['auth', 'admin', 'csrf']);
$router->post('/cpanel/integrations/ldap', 'CpanelController@saveLdapSettings', ['auth', 'admin', 'csrf']);
$router->post('/cpanel/integrations/sms', 'CpanelController@saveSmsSettings', ['auth', 'admin', 'csrf']);
$router->post('/cpanel/integrations/openai', 'CpanelController@saveOpenaiSettings', ['auth', 'admin', 'csrf']);
$router->post('/cpanel/integrations/test-smtp', 'CpanelController@testSmtp', ['auth', 'admin']);
$router->post('/cpanel/integrations/test-ldap', 'CpanelController@testLdap', ['auth', 'admin']);
$router->post('/cpanel/integrations/test-sms', 'CpanelController@testSms', ['auth', 'admin']);
$router->post('/cpanel/integrations/test-openai', 'CpanelController@testOpenai', ['auth', 'admin']);
